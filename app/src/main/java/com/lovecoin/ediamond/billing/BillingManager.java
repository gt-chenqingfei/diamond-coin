...
public class BillingManager implements PurchasesUpdatedListener {
     ...
     */
    private static final String BASE_64_ENCODED_PUBLIC_KEY = "";
    ...
    public interface BillingUpdatesListener {
        ...
        void onPurchaseFlowStatus(@BillingResponse int result);
        void onPurchaseHistoryResponse(int code, List<Purchase> list);
    }
        ...
        Runnable purchaseFlowRequest = new Runnable() {
            ...
            public void run() {
                ...
                BillingFlowParams purchaseParams = BillingFlowParams.newBuilder()
                                                                    ...
                                                                    .setOldSkus(oldSkus)
                                                                    .build();
                int onPurchaseFlowStatus = mBillingClient.launchBillingFlow(mActivity, purchaseParams);
                mBillingUpdatesListener.onPurchaseFlowStatus(onPurchaseFlowStatus);
            }
        };
                ...
                mBillingClient.queryPurchaseHistoryAsync(SkuType.INAPP,
                        new PurchaseHistoryResponseListener() {
                            ...
                            public void onPurchaseHistoryResponse(@BillingResponse int responseCode,
                                ...
                                mBillingUpdatesListener.onPurchaseHistoryResponse(responseCode, purchasesList);
                            }
                        });
            }
        };
        ...
        mBillingClient.startConnection(new BillingClientStateListener() {
            ...
            public void onBillingSetupFinished(@BillingResponse int billingResponseCode) {
                ...
                if (BuildConfig.DEBUG) {
                    ToastUtils.showLong("billing " + billingResponseCode);
                }
